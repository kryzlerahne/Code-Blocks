def stageThree():
    ...
    BranchTree = [pygame.image.load(os.path.join("Images/Objects", "branch1.png")),
            pygame.image.load(os.path.join("Images/Objects", "branch2.png")),
            pygame.image.load(os.path.join("Images/Objects", "branch3.png"))]
    Spooky = [pygame.image.load(os.path.join("Images/Objects", "candle.png")),
             pygame.image.load(os.path.join("Images/Objects", "eyeball.png")),
             pygame.image.load(os.path.join("Images/Objects", "graveyard.png")),
             pygame.image.load(os.path.join("Images/Objects", "skull.png"))]
    Clouds = pygame.image.load(os.path.join("Images/Objects", "clouds.png"))
    Birds = [pygame.image.load(os.path.join("Images/Objects", "birdLvl3.png")),
             pygame.image.load(os.path.join("Images/Objects", "bird2Lvl3.png"))]
    Background = pygame.image.load(os.path.join("Images/Objects", "ground3.png"))
    ...
    def score3():
        ...
        text1 = font.render("Level 3/5", True, (0, 0, 0))
        screen.blit(text1, (35, 20))

    def menu3(death_count):
        global scorePoints

        while True:
            if death_count == 0:
                def levelThree(x, y, w, h, image, imageOn, action=None):
                ...
                background = pygame.image.load(os.path.join("Images/Start", "level3map.png"))
                nextLevel = pygame.image.load(os.path.join("Images/Start", "level3button.png"))
                nextLevelHover = pygame.image.load(os.path.join("Images/Start", "level3buttonhover.png"))
                ...
                while True:
                    ...
                    levelThree(405, 326, 300, 50, nextLevel, nextLevelHover, "level3")  # x,y, width, height
                    pygame.display.update()

            elif death_count > 0:
                font = pygame.font.Font('Fonts/Affogato-Bold.otf', 22)
                background_image = pygame.image.load(os.path.join("Images/Start", "Level3Lose.png"))
    ...
    def triviaThree():
        trivia1 = pygame.image.load(os.path.join("Images/Trivias", "Trivia1Level3.png"))
        trivia2 = pygame.image.load(os.path.join("Images/Trivias", "Trivia2Level3.png"))
        trivia3 = pygame.image.load(os.path.join("Images/Trivias", "Trivia3Level3.png"))
        trivia4 = pygame.image.load(os.path.join("Images/Trivias", "Trivia4Level3.png"))
        trivia5 = pygame.image.load(os.path.join("Images/Trivias", "Trivia5Level3.png"))
        trivia6 = pygame.image.load(os.path.join("Images/Trivias", "Trivia6Level3.png"))
        trivia7 = pygame.image.load(os.path.join("Images/Trivias", "Trivia7Level3.png"))
        trivia8 = pygame.image.load(os.path.join("Images/Trivias", "Trivia8Level3.png"))
        trivia9 = pygame.image.load(os.path.join("Images/Trivias", "Trivia9Level3.png"))
        trivia10 = pygame.image.load(os.path.join("Images/Trivias", "Trivia10Level3.png"))
        ...
        while run:
            ...
            if len(obstacles) == 0:
                if random.randint(0, 3) == 0:
                    obstacles.append(SpookyBlocks(Spooky))
                elif random.randint(0, 2) == 0:
                    obstacles.append(Trees(BranchTree))
            ...
            if scorePoints >= 560:
                ...
                if player.character_rect.colliderect(star.rect):
                    ...
                    background_image = pygame.image.load(os.path.join("Images/Start", "Level3Complete.png"))
                    screen.blit(background_image, [0, 0])
